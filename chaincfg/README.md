...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/mraksoll4/btcd/chaincfg)
...
```bash
$ go get -u github.com/mraksoll4/btcd/chaincfg
```
