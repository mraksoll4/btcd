...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/mraksoll4/btcd/peer)
...
```bash
$ go get -u github.com/mraksoll4/btcd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/mraksoll4/btcd/peer#example-package--NewOutboundPeer)  
